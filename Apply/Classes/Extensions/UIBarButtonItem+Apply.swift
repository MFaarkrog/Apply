...
public extension UIBarButtonItem {
  ...
  @discardableResult public func apply<T: UIBarButtonItem>(action: Selector?) -> T {
    self.action = action
    return self as! T
  }
  ...
  @discardableResult public func apply<T: UIBarButtonItem>(possibleTitles: Set<String>?) -> T {
    self.possibleTitles = possibleTitles
    return self as! T
  }
  
  @discardableResult public func apply<T: UIBarButtonItem>(width: CGFloat) -> T {
    self.width = width
    return self as! T
  }
  
  @discardableResult public func apply<T: UIBarButtonItem>(customView: UIView?) -> T {
    self.customView = customView
    return self as! T
  }
  
  @discardableResult public func apply<T: UIBarButtonItem>(tintColor: UIColor?) -> T {
  ...
  @discardableResult public func apply<T: UIBarButtonItem>(backButtonTitlePositionAdjustment adjustment: UIOffset, for barMetric: UIBarMetrics) -> T {
    self.setBackButtonTitlePositionAdjustment(adjustment, for: barMetric)
    return self as! T
  }
  
  @discardableResult public func apply<T: UIBarButtonItem>(backButtonBackgroundVerticalPositionAdjustment adjustment: CGFloat, for barMetric: UIBarMetrics) -> T {
  ...
  @discardableResult public func apply<T: UIBarButtonItem>(titlePositionAdjustment adjustment: UIOffset, for barMetric: UIBarMetrics) -> T {
